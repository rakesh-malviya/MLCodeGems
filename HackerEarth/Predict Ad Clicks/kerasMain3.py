...
#   click_weight = class_weight.compute_class_weight('balanced', np.unique(y_tr), y_tr)
  kmodel = KerasModel()
  print("Training ...")  
  kmodel.fit(X_tr, y_tr,
              ...
              class_weight=get_class_weights(y_tr, smooth_factor=0.07))  
...
sub.to_csv('Keras_3_%s.csv' %(str(aucScore)), index=False)
